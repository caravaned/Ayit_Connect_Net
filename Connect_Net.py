...
def connect_net(UserName,Pwd,ISP):
    ...
    post_login = "http://172.168.254.6:801/eportal/?c=ACSetting&a=Login&protoco" \
                 "l=http:&hostname=172.168.254.6&iTermType=1&mac=000000000000&" \
